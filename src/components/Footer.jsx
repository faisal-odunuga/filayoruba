    ...
    <footer className="bg-[#0e0e0e] w-full py-20 px-8 border-t border-white/10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto">
        <div className="col-span-1 md:col-span-1">
          <div className="text-xl font-black text-white mb-4 uppercase font-headline">Fìlà Yorùbá</div>
          <p className="text-white/50 text-xs leading-relaxed font-body uppercase tracking-wider">
            Premium Yoruba fìlà crafted in Nigeria from heirloom Aso Oke — honoring legacy in every weave.
          </p>
          <div className="mt-8 flex gap-6 text-white/50">
            <a href="#" className="hover:text-white transition-colors text-xs font-label uppercase tracking-widest">@filayoruba</a>
            <a href="#" className="hover:text-white transition-colors text-xs font-label uppercase tracking-widest">@fila_yoruba</a>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="font-body text-xs tracking-widest uppercase text-white/30">© 2024 FÌLÀ YORÙBÁ. ALL RIGHTS RESERVED.</p>
        <p className="font-body text-[10px] tracking-widest uppercase text-white/20">Designed for the Yoruba Crown</p>
      </div>
    </footer>
  );
};
