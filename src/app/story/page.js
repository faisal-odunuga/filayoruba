    ...
    <div className="flex flex-col">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          ...
          <div className="lg:col-span-4 lg:pl-12 pb-4">
            <p className="font-body text-white/60 text-lg leading-relaxed max-w-sm">
              Fìlà Yorùbá crowns modern life with ancestral weaving. Each cap is crafted in Lagos from heirloom Aso Oke.
            </p>
          </div>
        </div>
        <div className="absolute right-8 top-1/2 -translate-y-1/2 hidden xl:block">
          <span className="text-monolith font-headline text-8xl font-black text-white/5 uppercase select-none">Yorùbá Crown</span>
        </div>
      </header>
      ...
      <section className="py-32 px-8 lg:px-20 bg-background">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="order-2 lg:order-1 relative aspect-[4/5] w-full">
            <Image src="/images/catalogue/hand_knitted-catalogue.jpg" alt="Heritage" fill className="object-cover" />
          </div>
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-white/60 font-body text-lg leading-relaxed">
              ...
              <p>Fìlà Yorùbá keeps the sacred geometry intact while refining the silhouette for today’s ceremonies, journeys, and celebrations.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2 relative group overflow-hidden h-[500px]">
              <Image src="/images/caps/FY-135.jpeg" alt="Aso Oke loom" fill className="object-cover grayscale transition-all duration-700 group-hover:grayscale-0" />
              <div className="absolute inset-0 bg-black/40 p-10 flex flex-col justify-end">
                ...
                <p className="text-white/70 max-w-xs">Our narrow-strip looms produce Aso Oke strips that are durable, breathable, and crown-ready.</p>
              </div>
            </div>
      ...
      <section className="py-40 px-8 lg:px-20 text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-5 pointer-events-none flex items-center justify-center">
          <span className="font-headline text-[30rem] font-black uppercase leading-none">FÌLÀ</span>
        </div>
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <Link href="/filas" className="inline-flex items-center gap-6 bg-primary text-black px-12 py-6 font-headline font-black uppercase tracking-widest hover:bg-white transition-all group">
