...
const categoryBanners = {
  All: '/images/catalogue/gobi-catalogue.jpg',
  'Gòbì': '/images/catalogue/gobi-catalogue.jpg',
  'Sénítọ̀': '/images/catalogue/senito-catalogue.jpg',
  'Hand-knitted': '/images/catalogue/hand_knitted-catalogue.jpg',
  'Fìlástìk Big Band': '/images/catalogue/filastik-big-catalogue.jpg',
  'Fìlástìk Small Band': '/images/catalogue/filastik-small-catalogue.jpg',
  'Jagaban': '/images/catalogue/jagaban-catalogue.jpg',
  'Abetíajá': '/images/catalogue/abetiaja-catalogue.jpeg',
  'Àdìgún': '/images/catalogue/adigun-catalogue.jpg',
};
...
const CatalogContent = () => {
  ...
  const heroImage = categoryBanners[queryCategory] || categoryBanners.All;
        ...
        <aside className='md:col-span-3 lg:col-span-2 space-y-12'>
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-3 gap-2'>
              {['F', 'XS', 'S', 'M', 'L', 'XL', 'XXL', 'XXXL'].map((size) => (
                <button
                  key={size}
